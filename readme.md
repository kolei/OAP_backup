...
* [Лекции 3 и 4](/articles/t1l3.md) (4 часа)  
...
* [Лекция 1](/articles/t4l1.md)  
Понятие подпрограммы. Процедуры и функции, их сущность, назначение и различие. Организация процедур, стандартные процедуры. Процедуры, определенные пользователем: синтаксис, передача аргументов.
* [Лекция 2](/articles/t4l2.md)  
Формальные и фактические параметры. Процедуры с параметрами, описание процедур.
* [Лекция 3](/articles/t4l3.md)  
Функции: способы организации и описание. Вызов функций, рекурсия. Программирование рекурсивных алгоритмов.
* [Лекция 4](/articles/t4l4.md)  
...
* [Лекция 1](/articles/t5l1.md) (4 часа)     
...
* [Лекция 1](/articles/t8l1.md)  
Проектирование объектно-ориентированного приложения. Создание интерфейса пользователя.
* [Лекция 2](/articles/t8l2.md)  
Программирование приложения. Тестирование, отладка приложения. Создание документации.

## Тема 9. Иерархия классов  
* [Лекция 1](/articles/t9l1.md) (4 часа)  
Классы объектно-ориентированного языка программирования: виды,  назначение, свойства, методы, события. Объявление класса, свойств и методов экземпляра класса. Наследование. Перегрузка методов. Шаблоны проектирования.

- Лабораторная работа 1 (6 часов)   
Создание объектно-ориентированного приложения по индивидуальным заданиям.

## Тема 10. Визуальное событийно-управляемое программирование
* [Лекция 1](/articles/t10l1.md)  
...
* [Лекция 2](/articles/t10l2.md)  
Свойства компонентов (элементов управления). Виды свойств. Синтаксис определения свойств. Категория свойств. Назначение свойств и их влияние на результат.
* [Лекция 3](/articles/t10l3.md)  
Управление объектом через свойства. События компонентов (элементов управления), их сущность и назначение. Создание процедур на основе событий.
* [Лекция 4](/articles/t10l4.md)  
